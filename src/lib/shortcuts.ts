...
export const SHORTCUTS: readonly ShortcutDoc[] = [
  { group: "Transport", keys: "Space", label: "Play / pause", event: ev(" "), command: "togglePlay" },
  ...
  { group: "Transport", keys: "⌘I", label: "Clear in/out", event: ev("i", { mod: true }), command: "clearPlayRange" },
  { group: "Transport", keys: "⌘←  ⌘→", label: "Jump to previous / next edit", event: ev("ArrowRight", { mod: true }), command: "jumpEdit" },
  ...
  { group: "Editing", keys: "⌘V", label: "Paste at playhead, on the current track", event: ev("v", { mod: true }), command: "paste" },
  { group: "Editing", keys: "⌘D", label: "Duplicate", event: ev("d", { mod: true }), command: "duplicate" },
  { group: "Editing", keys: "Delete", label: "Delete selection", event: ev("Delete"), command: "delete" },
  { group: "Editing", keys: "←  →", label: "Nudge by 0.1 s (⇧ for 0.01 s)", event: ev("ArrowRight"), command: "nudge" },
  { group: "Editing", keys: "⌘Z", label: "Undo", event: ev("z", { mod: true }), command: "undo" },
  { group: "Editing", keys: "⇧⌘Z", label: "Redo", event: ev("z", { mod: true, shift: true }), command: "redo" },
  { group: "Editing", keys: "⌘A", label: "Select all clips", event: ev("a", { mod: true }), command: "selectAll" },

  { group: "Tracks", keys: "M", label: "Mute current track", event: ev("m"), command: "toggleMute" },
  { group: "Tracks", keys: "⇧S", label: "Solo current track", event: ev("S", { shift: true }), command: "toggleSolo" },

  { group: "View", keys: "+  −", label: "Zoom in / out", event: ev("="), command: "zoom" },
  { group: "View", keys: "⇧F", label: "Zoom to fit", event: ev("F", { shift: true }), command: "zoomFit" },
  { group: "View", keys: "?", label: "This list", event: ev("?", { shift: true }), command: "showHelp" },

  { group: "File", keys: "⌘S", label: "Save project", event: ev("s", { mod: true }), command: "save" },
];
